...
from piecrust.exceptions import ImproperlyConfigured, UnsupportedFormat
from piecrust.utils import format_datetime, format_date, format_time
try:
    import simplejson
except ImportError:
...
class DateTimeJSONEncoder(simplejson.JSONEncoder):
    ...
    Ripped from ``django.core.serializers.json.DjangoJSONEncoder``.
    """
...
class Serializer(object):
    ...
    def force_unicode(self, thing):
        """
        Roughly based on ``django.utils.encoding.force_unicode`` but less
        competent/specific.
        """
        ...
        if hasattr(thing, '__unicode__'):
            ...
            return unicode(thing, 'utf-8', 'strict')
    ...
    def to_json(self, data, options=None):
        ...
        return simplejson.dumps(data, cls=DateTimeJSONEncoder, sort_keys=True)
